...
| attached | boolean | true if the element belongs to the current window document. |
| isConnected | boolean | true if the element is connected to any document tree (Node.isConnected). |
